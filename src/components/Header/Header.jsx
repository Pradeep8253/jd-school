  ...
  const MenuItem = ({ item, index }) => {
    ...
    return (
      <li
        ...
        onMouseEnter={() =>
          hasDropdown && window.innerWidth >= 768 && setActiveDropdown(index)
        }
        onMouseLeave={() =>
          hasDropdown && window.innerWidth >= 768 && setActiveDropdown(null)
        }
      >
        <Link
          to={item.path}
        ...
        {hasDropdown && (
          <ul
            ...
            } md:group-hover:block absolute left-0 bg-gray-800 shadow-lg mt-0 rounded min-w-[200px] z-50`}
          >
