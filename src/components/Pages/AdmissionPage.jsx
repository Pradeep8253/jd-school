          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <h5 className="text-xl font-semibold">
                Admission is a 2 step process as follows:
              </h5>
              <br />
              <h5 className="text-lg font-semibold">
                Step 1- Procuring Prospectus:
              </h5>
              <p className="mt-2">
                It can be collected on payment from the school administrative
                office on all working days between 8.00 a.m. – 2.00 p.m.
              </p>
              <h5 className="text-lg font-semibold mt-4">
                Step 2- Registration:
              </h5>
              <p className="mt-2">
                The applicant is required to submit the following in the school:
              </p>
              <ul className="list-disc pl-5 mt-2">
                ...
                <li>
                  5. Date of Birth Certificate issued by the Municipal
                  Corporation;
                </li>
