...
export default function Activity() {
  ...
  const fetchActivities = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/api/activity/get`
        //
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}/api/activity/post`,
        formData,
        {
          headers: {
  ...
  const handleEdit = async (id) => {
    ...
    try {
      await axios.put(
        `${process.env.REACT_APP_BACKEND_URL}/api/activity/edit/${id}`,
        formData,
        {
          headers: {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `${process.env.REACT_APP_BACKEND_URL}/api/activity/delete/${id}`
      );
