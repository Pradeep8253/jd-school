...
export default function Gallery() {
  ...
  const fetchGallery = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/api/gallery/get`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}/api/gallery/post`,
        formData,
        {
          headers: {
  ...
  const handleEdit = async (id) => {
    ...
    try {
      await axios.put(
        `${process.env.REACT_APP_BACKEND_URL}/api/gallery/edit/${id}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `${process.env.REACT_APP_BACKEND_URL}/api/gallery/delete/${id}`
      );
