...
export default function Announcement() {
  ...
  const fetchAnnouncements = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/api/admin/get/announcements`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}/api/admin/post/announcements`,
        { text }
      );
  ...
  const handleEdit = async (id) => {
    ...
    try {
      const response = await axios.put(
        `${process.env.REACT_APP_BACKEND_URL}/api/admin/update/announcements/${id}`,
        { text: editText }
      );
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `${process.env.REACT_APP_BACKEND_URL}/api/admin/delete/announcements/${id}`
      );
